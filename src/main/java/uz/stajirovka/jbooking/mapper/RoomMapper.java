...
public interface RoomMapper {
    ...
    @Mapping(source = "entity.hotel.id", target = "hotelId")
    @Mapping(source = "entity.hotel.name", target = "hotelName")
    ...
    RoomResponse toResponse(RoomEntity entity, @Context Currency currency, @Context CurrencyConverterService currencyConverterService);
}
